...
// $studentID='23A050411';
$cert_no=$_POST["reg_no"];
$query = "SELECT * FROM `candEnrolled` WHERE cert_no='$cert_no'";
...
$cert_no = $row['cert_no'];
// $cert_link = "certificate"+$cert_no+".pdf";
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="rbt-address">
                        <div class="inner">
                            <?php if (isset($cert_no) && $cert_no !== 0) {
                                echo '<a class="btn btn-success" href="certificate/' . $cert_no . '.pdf">Download Certificate</a>';
                              } ?>
